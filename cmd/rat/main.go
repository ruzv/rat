...
import (
	...
	"github.com/ruzv/rat/internal/args"
	"github.com/ruzv/rat/internal/config"
	"github.com/ruzv/rat/internal/graph/services/runner"
)
...
func run() error {
	...
	webStaticContent, err := fs.Sub(embedStaticContent, "embed")
	if err != nil {
